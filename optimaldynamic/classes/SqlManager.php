 ...
 *
 *****************************************************************************/
include_once(dirname(dirname(__FILE__)) . "/classes/Logger.php");
...
class SqlManager
{
	...
	private function OpenConnection()
	{
		...
		{
			Logger::LogError(dirname(dirname(__FILE__)) . "/logs/mysql_error.txt", Logger::$APPEND, 
	...
	public function Execute($l_sql, $l_returntype='array', $l_attempts=0)
	{
		...
		if($this->OpenConnection())
		{
			...
			{
				Logger::LogError(dirname(dirname(__FILE__)) . "/logs/mysql_error.txt", Logger::$APPEND, "Failed to execute statement: (" . $this->l_connection->errno . ") " . $this->l_connection->error);
